...
public class ContributionFrame extends javax.swing.JFrame {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
       try{
        ...
        String fund_name = fundComboBox.getSelectedItem( ).toString();
        String amount = amountTextField.getText( );
        String note = noteTextPane.getText( );
        int env_num = Integer.parseInt( envID );
        double amt=Double.parseDouble(amount);
        String c_type = typeComboBox.getSelectedItem( ).toString();
        String sDate = dateTextField.getText();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            java.util.Date x = sdf.parse(sDate);
            java.sql.Date sqlDate = new java.sql.Date(x.getTime());
        Contribution contribution=new Contribution(amt,sqlDate,note,c_type,fund_name,env_num);
